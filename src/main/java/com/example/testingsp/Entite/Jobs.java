...
public class Jobs {
    ...
    public Jobs(int id_jobs, String nom_job, String description_job, Date dateCreation, Date deadline, String priorite, String status, String userCreation, String mot_cle, String canal, String secteur_opportunite, List<Commentaire> commentaires, List<Prospect> prospects) {
    ...
    public Jobs(String nom_job, String description_job, Date dateCreation, Date deadline, String priorite, String status, String userCreation, String mot_cle, String canal, String secteur_opportunite, List<Commentaire> commentaires, List<Prospect> prospects) {
        this.nom_job = nom_job;
        this.description_job = description_job;
        this.dateCreation = dateCreation;
        this.deadline = deadline;
