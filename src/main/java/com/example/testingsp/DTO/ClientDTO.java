...
public class ClientDTO {
    ...
    public ClientDTO(int clientid, String clientname, String client_add, String client_ice, List<Mission> mission, List<Apoffres> apofres, Date dateCreation, String userCreation) {
