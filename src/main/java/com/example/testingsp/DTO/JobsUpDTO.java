...
public class JobsUpDTO {
    ...
    public JobsUpDTO(int id_jobs, String nom_job, String description_job, Date dateCreation, Date deadline, String priorite, String status, String userCreation, String mot_cle, String canal, String secteur_opportunite, List<Commentaire> commentaires, List<Prospect> prospects) {
